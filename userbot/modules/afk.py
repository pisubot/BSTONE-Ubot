        ...
        if reason:
            ...
            try:
                if pic.endswith((".tgs", ".webp")):
                    await bot.send_message(event.chat_id, file=pic)
                    await bot.send_message(
                        event.chat_id, f"**⭕️ {ALIVE_NAME} Telah AFK ⭕️**"
                    )
                else:
                    await bot.send_message(
                        event.chat_id,
                        f"**⭕️ {ALIVE_NAME} Telah AFK ⭕️**",
                        file=pic,
                    )
            except BaseException:
                await bot.send_message(event.chat_id, f"**⭕️ {ALIVE_NAME} Telah AFK ⭕️**")
        await event.delete()
        try:
            if reason and pic:
                if pic.endswith((".tgs", ".webp")):
